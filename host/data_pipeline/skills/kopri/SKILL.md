...
allowed-tools: Read, Write, Bash(python -m data_pipeline.skills.kopri.main *)
---
...
2. 아래 명령으로 변환 실행:
   ```
   python -m data_pipeline.skills.kopri.main --source https://kpdc.kopri.re.kr/search/{uuid} --output kopri_dataon.json
   ```
