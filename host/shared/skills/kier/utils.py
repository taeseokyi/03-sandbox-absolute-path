...
INSTITUTION_INFO: dict[str, str] = {
    "기관명_한글": "한국에너지기술연구원",
    "기관명_영문": "Korea Institute of Energy Research",
    "약어": "KIER",
    "분야": "에너지·자원·원자력",
    "과학기술표준분류": "에너지",
}
...
def detect_format(source: str) -> str:
    """파일 확장자 또는 URL 여부로 포맷 반환: url | csv | json | jsonl | excel"""
    s = source.strip()
